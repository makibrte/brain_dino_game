...
class Dinosaur:
    ...
    def update(self, userInput):
        ...
        if (userInput[pygame.K_UP] or userInput[pygame.K_a]) and not self.dino_jump:
            self.dino_duck = False
            self.dino_run = False
            self.dino_jump = True
...
# Game thread (already in your code)
